	...
	public void actionPerformed(ActionEvent e) {
		...
		if (z == btnAddBacteria) {
			...
			if (modelBacteriesList.size() != 0 && listBacteries.getSelectedIndex() != -1) {
				...
				JOptionPane.showMessageDialog(null, "Empty list or do not choose bacteria!", "Warning",
						JOptionPane.WARNING_MESSAGE);
			if (modelBacteriesList.size() == 0)
				btnSaveToDatabase.setEnabled(false);
		} else if (z == btnExit) {
			if (JOptionPane.showConfirmDialog(null, "Are you sure you want to exit?", "Question",
